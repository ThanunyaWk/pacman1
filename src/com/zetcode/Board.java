...
public class Board extends JPanel implements ActionListener {
    ...
    private void initBoard() {
        ...
        setFocusable(true); //Focus หน้าจอ

        setBackground(Color.black); //set bg
    }

    private void initVariables() {

        screenData = new short[N_BLOCKS * N_BLOCKS];
        mazeColor = new Color(5, 100, 5); //สีเขาวงกต
        d = new Dimension(400, 400);
        ghost_x = new int[MAX_GHOSTS]; //พิกัดของผี
    ...
    private void showIntroScreen(Graphics2D g2d) {
        ...
        String s = "Press spacebar to start."; //จอตอนกดเริ่มเกม
    ...
    private void loadImages() {  //เอารูปมาเก็บในตัวแปร
